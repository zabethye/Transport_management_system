...
username = StringVar()
username_entry = ttk.Entry(register_page, textvariable=username, font=5).grid(row=2, column=1)

#Creating password box
password_label = Label(register_page, text="Enter your password:     ", font=5).grid(row=3, column=0)
password = StringVar()
password_entry = ttk.Entry(register_page, textvariable=password, show="*", font=5).grid(row=3, column=1)

#Creating email box
email_label = Label(register_page, text="Enter your E-mail:          ", font=5).grid(row=4, column=0)
email = StringVar()
email_entry = ttk.Entry(register_page, text=email, font=5).grid(row=4, column=1)

#Creating first name box
first_name_label = Label(register_page, text="Enter your first name:     ", font=5).grid(row=6, column=0)
first_name = StringVar()
first_name_entry = ttk.Entry(register_page, text=first_name, font=5).grid(row=6, column=1)

#Creating last name box
last_name_label = Label(register_page, text="Enter your last name:      ", font=5).grid(row=7, column=0)
last_name = StringVar()
last_name_entry = ttk.Entry(register_page, text=last_name, font=5).grid(row=7, column=1)

#Creating position box
position_label = Label(register_page, text="Enter your position:         ", font=5).grid(row=8, column=0)
position = StringVar()
position_entry = ttk.Entry(register_page, text=position, font=5).grid(row=8, column=1)

#Creating telephone number box
phone_number_label = Label(register_page, text="Enter your phone number:", font=5).grid(row=9, column=0)
phone_number = StringVar()
phone_number_entry = ttk.Entry(register_page, text=phone_number, font=5).grid(row=9, column=1)
...
register_btn = Button(register_page, text="Register!", command=registration_validation, font=5).grid(row=10, column=1)
